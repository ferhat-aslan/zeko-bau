...
<CardGrid>
  <Card title="Ensemble de tournevis" icon="seti:config">
    ...
    <LinkCard title="En savoir plus " href="en/guides/getting-started" />
  </Card>
...
1. Icône de déballage Déballez vos outils zekobau
